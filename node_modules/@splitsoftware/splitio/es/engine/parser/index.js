...
function parse(conditions, storage) {
  ...
  for (var conditionKey in conditions) {
    var _conditions$condition = conditions[conditionKey],
        matchers = _conditions$condition.matcherGroup.matchers,
        partitions = _conditions$condition.partitions,
        label = _conditions$condition.label,
        conditionType = _conditions$condition.conditionType; // transform data structure
