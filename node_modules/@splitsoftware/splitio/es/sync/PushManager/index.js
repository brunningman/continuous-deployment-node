...
/* undefined for node */
  ...
  function connectPush() {
    ...
    authenticate(settings, userKeys).then(function (authData) {
      ...
      log.error("Fail to authenticate for push notifications, with error message: \"".concat(error.message, "\". Attempting to reauthenticate in ").concat(delayInMillis / 1000, " seconds."));
    });
