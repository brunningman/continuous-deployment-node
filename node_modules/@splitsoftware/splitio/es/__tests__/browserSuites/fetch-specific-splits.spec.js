...
import { splitFilters, queryStrings, groupedFilters } from '../mocks/fetchSpecificSplits'; // import splitChangesMock1 from '../mocks/splitchanges.since.-1.json';
...
export default function fetchSpecificSplits(fetchMock, assert) {
  ...
  var _loop = function _loop(i) {
    ...
    if (groupedFilters[i]) {
      ...
      fetchMock.get(urls.sdk + '/mySegments/nicolas@split.io', {
        status: 200,
        body: {
          'mySegments': []
        }
