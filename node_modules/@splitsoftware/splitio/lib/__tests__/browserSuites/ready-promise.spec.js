...
function readyPromiseAssertions(fetchMock, assert) {
  ...
  assert.test(function (t) {
    ...
    fetchMock.get(config.urls.sdk + '/mySegments/facundo@split.io', _mysegmentsFacundoSplitIo.default, {
      delay: fromSecondsToMillis(config.startup.requestTimeoutBeforeReady) - 20
    });
  ...
  assert.test(function (t) {
    ...
    fetchMock.get(config.urls.sdk + '/mySegments/nicolas@split.io', _mysegmentsFacundoSplitIo.default); // shared client endpoint configured to emit SDK_READY_TIMED_OUT

    fetchMock.get(config.urls.sdk + '/mySegments/emiliano@split.io', _mysegmentsFacundoSplitIo.default, {
  ...
  assert.test(function (t) {
    ...
    fetchMock.get(config.urls.sdk + '/mySegments/nicolas@split.io', _mysegmentsFacundoSplitIo.default);
    fetchMock.get(config.urls.sdk + '/mySegments/emiliano@split.io', _mysegmentsFacundoSplitIo.default);
    fetchMock.postOnce(config.urls.events + '/testImpressions/bulk', 200);
    var splitio = (0, _.SplitFactory)(config);
